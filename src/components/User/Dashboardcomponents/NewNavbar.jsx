...
function NewNavbar() {
  return (
    <nav
      class="sticky top-0 z-10 block w-full max-w-full px-4 py-2 text-white bg-green-500 border rounded-none shadow-md h-max border-white/80 bg-opacity-80 backdrop-blur-2xl backdrop-saturate-200 lg:px-8 lg:py-4">
