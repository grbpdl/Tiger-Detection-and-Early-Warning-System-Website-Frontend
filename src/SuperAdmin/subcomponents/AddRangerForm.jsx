...
import { addRangerValidation } from '../../helper/validate';
...
const AddRangerForm = ({ openPopUp, closePopUp, refreshUsers }) => {
    ...
    return (
        <div
            ...
            <div className='p-2 bg-gray-500 w-10/12 md:w-1/2 lg:1/3 shadow-inner border-e-emerald-600 rounded-lg py-5'>
                <div className='w-full p-3 justify-center items-center'>
                    <h2 className='font-semibold py-3 text-center text-xl text-green-500'>
                        Add Ranger
                    </h2>
